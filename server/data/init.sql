...
INSERT INTO journal (event, todo_uuid) VALUES
    ('{"time":"2023-08-28T15:38:05.754673029Z", "action":"refuel"}', (SELECT uuid FROM todos WHERE description = 'Deliver to KS')),
    ('{"time":"2023-08-27T15:38:05.754673029Z", "action":"delivery"}', (SELECT uuid FROM todos WHERE description = 'Deliver to KS')),
    ('{"time":"2023-07-27T15:38:05.754673029Z", "action":"delivery"}', (SELECT uuid FROM todos WHERE description = 'Fill tank at I25')),
    ('{"time":"2023-06-28T15:38:05.754673029Z", "action":"refuel"}', (SELECT uuid FROM todos WHERE description = 'Fill tank at I25')),
    ('{"time":"2023-04-27T15:38:05.754673029Z", "action":"pickup"}', (SELECT uuid FROM todos WHERE description = 'Collect load from PA'));
